...
The STEM Interface demonstrates the many different connection STEM fields have with other non-STEM related fields 
and the foundations upon which it was built. 

The project makes use of a ZUI style interactable site to demonstrate these connections.
